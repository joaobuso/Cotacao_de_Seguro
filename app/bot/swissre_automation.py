...
class SwissReAutomation:
  ...
  def generate_quotation_pdf(client_data):
    ...
    try:
      ...
      logger.info(f"Erro ao gerar documento: {response_doc.text}")
      return {
          "success": False,
          "pdf_url": "pdf_url",
          "pdf_path": "path_file",
          "message": "Cotação criada, mas houve erro ao gerar o PDF.",
          "quotation_number": contractNumber,
          "document_status_code": response_doc.status_code,
          "document_response": response_doc.text
      }
